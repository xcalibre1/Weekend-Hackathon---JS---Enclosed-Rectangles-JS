...
function updateStructure(rec1,rec2){
	...
	let right2=Number(rec2.right.substr(0,rec2.width.length-2)),right1=Number(rec1.right.substr(0,rec2.width.length-2));
	let bottom2=Number(rec2.bottom.substr(0,rec2.width.length-2)),bottom1=Number(rec2.bottom.substr(0,rec2.width.length-2));
